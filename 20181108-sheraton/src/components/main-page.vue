<template>
  <div class="main-page">
    <div class="form-container" id="form">
      ...
      <div class="coupon">
        <!-- <img v-if="activity == 'new-user-online'" src="./img/coupon55.png" alt="">
    ...
    <div class="rules">
      <h3>领取须知：</h3>
      <ul>
        <li>输入手机号码后，未注册的新用户将领取3755元用车优惠券组合礼包，已注册过的老用户将获得3700元用车优惠券组合礼包。</li>
        <li>此处收集的手机号码仅作为活动识别，不另作他用</li>
          ...
          .then(res => {
            if(res.msg == '活动暂时未开始'){
              ...
              if (res.userInfo.newUser) {
                ...
                this.$emit('nextPage', 'oldDriverSuccess')
              } else {
